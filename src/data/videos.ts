...
export const sampleVideos: VideoProject[] = [
  ...
  // ── Promotional Edits ──
  {
    ...
    videoUrl: '/videos/promotional-edits/ar-construction-edit.mov',
  ...
  },
  {
    ...
    category: 'promotional-editing',
    categoryLabel: 'Promotional Editing',
    videoUrl: '/videos/promotional-edits/ramvan-hotel-edit.mov',
  ...
  // ── Travel & Education ──
  {
    ...
    videoUrl: '/videos/travel-education/bhojpur-temple.mov',
